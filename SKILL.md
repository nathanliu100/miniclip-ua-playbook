...
交付时：
- 所有 md 脚本放项目根目录
- HTML brief 放 `Ideation/`
- 参考图放 `02_Assets/`
- 最后用 `deliver_attachments` 把所有关键文件传给 Nate
...
Phase 1 · 我会先扒完这些信息：
 □ 开发商 / 收购关系 / 累计下载 / 月收入（Sensor Tower）
 □ 核心玩法 + 3–5 条 USP
 □ 3–4 个竞品 + 相似/差异
 □ 目标受众画像（核心动机）
 □ 现有 UA 素材在跑的类型（TikTok Creative Centre + Meta Ad Library）
 □ 工作室近几个月 Brief 的方向
...
调研产出后，按 Phase 2 → 3 → 4 顺序推进，**每个 Phase 完成后问 Nate 要不要继续**（他习惯分阶段 review）。
